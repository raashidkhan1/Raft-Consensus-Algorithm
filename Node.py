...
#        print("Time execution for heartbeat:",time.time()-start_time,flush=True)

        print(f"{self.node_name} Time execution heartbeat",time.time()-start_time)
    ...
    def candidate(self):
        ...
        if self.vote_count > min_vote:
            ...
            print(f"{self.node_name} Time execution Election",time.time()-start_time)
        else:
